/* https://github.com/NativeScript/sample-Groceries/blob/angular-end/app/utils/status-bar-util.ts */
  ...
  if (application.android) {
    application.android.onActivityStarted = function() {
      if (application.android && platform.device.sdkVersion >= "21") {
        ...
        window.setStatusBarColor(new color.Color('#3F51B5').android);
        
        /*
        window.setStatusBarColor(0x000000);
        window.setNavigationBarColor(new color.Color('#3F51B5').android);
